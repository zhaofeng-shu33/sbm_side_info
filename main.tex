...
\begin{document}
	...
	Yet, 
	the difference between the balanced assumption in this paper and the equal probability assumption in \cite{abbe17sideinfo},  and also the contributions of this paper, are as follows. 
...
% 	\end{figure}
	...
	Our result provides insight on the number of node samples to achieve exact recovery. We also proposed an Semidefinite programming based algorithm that achieves the threshold with high probability.
