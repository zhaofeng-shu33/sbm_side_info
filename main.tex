...
D_2 = m\frac{D(p_1||p_0)}{\log a/b}, J_n = \mathbbm{1}_n \mathbbm{1}_n^T - I_n, \bar{D}=\frac{D_1+D_2}{2}$.
...
\end{align*}
$\Gamma_1$ is a diagonal matrix, and we can control each of its element respectively.
